    ...
    try:
        ...
        if cached_answer:
            ...
            ***
            ...
            3.  **ความลื่นไหล:** เรียบเรียงใหม่ให้กระชับ อ่านง่าย ข้อความไม่ยาวจนเกินไป

            **กฎเหล็กในการแสดงรูปภาพ:**
            1.  ให้ใส่แท็กรูปภาพ **เฉพาะเมื่อ** ผู้ใช้ถามเจาะจงถึง "หัวข้อเดียว" หรือ "สถานที่เดียว" เท่านั้น
            2.  ❌ **ห้าม** ใส่แท็กรูปภาพในกรณีที่เป็นการ "แสดงรายชื่อ" (List), "สรุปภาพรวม", หรือ "บอกหัวข้อทั้งหมด" (เช่น ถามว่ามีแผนกอะไรบ้าง ห้ามใส่แท็กต่อท้ายรายชื่อแผนก)
            3.  ถ้าผู้ใช้ไม่ได้ถามเจาะจง อย่าเพิ่งเสนอรูปภาพ
